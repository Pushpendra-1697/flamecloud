...
const Landing = () => {
    ...
    return (
        <Box fontFamily={"Figtree"} fontStyle="normal" mt="12%">
            ...
            <Box textAlign={"center"} fontSize={{ base: "46px", sm: "46px", lg: "56px" }} lineHeight={{ base: "67.2px", sm: "103.2px", lg: "67.2px" }} m={{ base: "3px 20px", sm: "4px 20px", lg: "3px 400px" }} w={{ base: "100%", sm: "100%", lg: "824px" }} h={{ base: "auto", sm: "auto", lg: "134px" }}>
