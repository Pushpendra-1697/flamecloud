...
const Landing = () => {
    ...
    return (
        <Box fontFamily={"Figtree"} fontStyle="normal">
            ...
            <Text color={"#111822"} display={"flex"} justifyContent="center" alignItems={"center"} mt={{ base: "95px", sm: "100.95px", lg: "95px" }} fontSize={{ base: "16px", sm: "30px", lg: "16px" }}
                ml={{ base: '0', sm: "14%", lg: '0' }}
                textAlign="center">WELCOME TO CREATIVE PROXIES</Text>
            ...
            <Box mb="26px" mt={{ base: "17px", sm: "26px", lg: "17px" }} lineHeight={{ base: "26.4px", sm: "48px", lg: "26.4px" }} m="auto" fontSize={{ base: "22px", sm: "40px", lg: "22px" }} w={{ base: "509px", sm: "899px", lg: "509px" }} fontWeight={"500"} h={{ base: "52px", sm: "92px", lg: "52px" }} ml={{ base: "40%", sm: "14%", lg: "40%" }}>Lorem ipsum dolor sit amet, consectetur adipiscing elit. In luctus augue sit amet mollis molestie.</Box>
            <Box textAlign={"center"} mt="26px"><Button bg="blue" w="222px" h={"47px"} color={"white"} p={{ base: '12px 55px', sm: "26px 115px", lg: "12px 55px" }} fontSize={{ base: "18px", sm: "37.3px", lg: "18px" }}>Get Started<AiOutlineArrowRight /></Button></Box>
            <Box bg="#00B67A1A" w={{ base: "200px", sm: "480px", lg: "200px" }} borderRadius={"10px"} m="auto" mt="22px" mb="54px" textAlign={"center"}>
                <Box padding={"10px"}>
                ...
                <Text fontSize={{ base: "16px", sm: "33.15px", lg: "16px" }} padding={"10px"} mt="8.45px">Rated 4.5 on <Icon color="#00B67A" as={AiFillStar} /> Trustpilot</Text>
            </Box>
            ...
            <Box mb="177px" fontWeight={"500"} bg="#0566D4" w={{ base: "100%", sm: "1220px", lg: "100%" }}>
                <Box display={"flex"} alignItems="center" justifyContent={"center"}>
                    <Box pt="115px">
                        ...
                        <Text ml="20px" w={{ base: "465px", sm: "711.73px", lg: "465px" }} color={"#FFFFFF"} lineHeight={{ base: "21.6px", sm: "33.06px", lg: "21.6px" }} mt="10px" fontSize={{ base: "18px", sm: "27.55px", lg: "18px" }}>Lorem ipsum dolor sit amet, consectetur adipiscing elit. In luctus augue sit amet mollis molestie.</Text>
                    </Box>
                </Box>
                ...
                <Box pl="15px" pb="114px" w={{ base: "85%", sm: "100%", lg: "85%" }} m="auto" display={"grid"} gap={{ base: '16px', sm: "24.49px", lg: "16px" }} gridTemplateColumns={{ base: "repeat(4,1fr)", sm: "repeat(2,1fr)", lg: "repeat(4,1fr)" }}>
                    {featuresData && featuresData.map(({ id, feature, lorem }) =>
                        <Box w={{ base: "286px", sm: "437.76px", lg: "286px" }} h={{ base: "160px", sm: "244.9px", lg: "160px" }} borderRadius={"5px"} color={"#FFFFFF"} mt="30px" padding={"25px"} border={"1px solid #D4EAE8"} key={id} p="22px 25px">
                            ...
                            <Text lineHeight={{ base: "16.8px", sm: "25.71px", lg: "16.8px" }} fontSize={{ base: "14px", sm: "21.43px", lg: "14px" }} fontWeight="400">{lorem}</Text>
                        </Box>
                    )}
                </Box>
            </Box>
            ...
            <Box mb={{ base: "79px", sm: "66.69px", lg: "79px" }} display={"flex"} justifyContent="center" flexDirection={"column"} alignItems="center" w={{ base: "50%", sm: "1200px", lg: "50%" }} m="auto">
                ...
                <Text w={{ base: "465px", sm: "861px", lg: "465px" }} lineHeight={{ base: "21.6px", sm: "39.99px", lg: "21.6px" }} fontSize={{ base: "18px", sm: "33.33px", lg: "18px" }}>Lorem ipsum dolor sit amet, consectetur adipiscing elit. In luctus augue sit amet mollis molestie.</Text>
            </Box>
            ...
            <Box borderRadius={{ base: "5px", sm: "7.24px", lg: "5px" }} border={"1px solid #1E1E1E1A"} bg="#1E1E1E1A" display="flex" justifyContent={"center"} alignItems="center" w={{ base: "708px", sm: "900px", lg: "708px" }} h={{ base: "142px", sm: "206px", lg: "142px" }} gap={{ base: "34px", sm: "49.24px", lg: "34px" }} margin="auto" mt={{ base: "21px", sm: "49px", lg: "21px" }} ml={{ base: "25.8%", sm: "27%", lg: "25.8%" }}>
                <Box>
                    <Box display={"flex"} justifyContent="center" alignItems={"center"} borderRadius="10px" bg="#FFDE2E" w={{ base: "35px", sm: "57.93px", lg: "35px" }} padding={{ base: "5px", sm: "10px", lg: "5px" }}>
                        <GiFrogPrince color='#FFFFFF' fontSize={{ base: "23px", sm: "33px", lg: "23px" }} />
                    </Box>
                    <Heading fontSize={{ base: "20px", sm: "28.96px", lg: "20px" }} fontWeight="600">Become a Reseller</Heading>
                    <Text fontSize={{ base: "16px", sm: "23.17px", lg: "16px" }} fontWeight="400">200+ Happy Resellers</Text>
                </Box>
                <Box fontSize={{ base: "16px", sm: "23.17px", lg: "16px" }}>
                    <Text mb={{ base: "10px", sm: "14.48px", lg: "10px" }}>Plan Includes :</Text>
            ...
            <Box mt={{ base: "180px", sm: "201.29px", lg: "180px" }} display={"flex"} justifyContent="center" flexDirection={"column"} alignItems="center" mb={{ base: "34px", sm: "100.49px", lg: "34px" }} w={{ base: "40%", sm: "1200px", lg: "40%" }} m={{ base: "auto" }}>
                ...
                <Text w={{ base: '465px', sm: "766.06px", lg: "465px" }} lineHeight={{ base: "21.6px", sm: "35.58px", lg: "21.6px" }} fontSize={{ base: "18px", sm: "29.65px", lg: "18px" }}>Lorem ipsum dolor sit amet, consectetur adipiscing elit. In luctus augue sit amet mollis molestie.</Text>
            </Box>
            ...
            <Box display={"flex"} w={{ base: "75%", sm: "1200px", lg: "75%" }} m="auto" gap={{ base: "17px", sm: "28.01px", lg: "17px" }} flexDirection={{ base: "row", sm: "column", lg: "row" }} justifyContent="center" alignItems={"center"} >
                <Box border={"1px solid #16D11380"} borderRadius={{ base: "5px", sm: "8.24px", lg: "5px" }} bg="#1E1E1E03" w={{ base: "386px", sm: "635.91px", lg: "386px" }} h={{ base: "248px", sm: "408.56px", lg: "248px" }}>
                    <Box p="29px 0 32.1px 25px">
                        ...
                        <Box mt={{ base: "12px", sm: "28.91px", lg: "12px" }} display={"flex"} gap="10px">
                            ...
                            <Box fontWeight={"400"}>
                                ...
                                <Text fontSize={{ base: "16px", sm: "26.36px", lg: "16px" }}>Web Designer, CreativeProxies</Text>
                            </Box>
                        </Box>
                    </Box>
                </Box>
                    ...
                    <Box p="29px 0 32.1px 25px">
                        ...
                        <Box mt={{ base: "12px", sm: "28.91px", lg: "12px" }} display={"flex"} gap="10px">
                            ...
                            <Box fontWeight={"400"}>
                                ...
                                <Text fontSize={{ base: "16px", sm: "26.36px", lg: "16px" }}>Random Text, ABC</Text>
                            </Box>
                        </Box>
                    </Box>
                </Box>
            ...
            <Box w="1192px" h={{ base: "859px", sm: "1096px", lg: "859px" }} bg="#F6FAFF" borderRadius={"5px"} border="1px solid #077BFF80" m="auto" mb={{ base: "120px", sm: "320px", lg: "120px" }} mt={{ base: "250px", sm: "234.33px", lg: "250px" }} display="flex" flexDirection={"column"} justifyContent="center" alignItems={"center"}>
                <Box p="65px 40px 35px 40px" display={"flex"} justifyContent="center" flexDirection={"column"} alignItems="center">
                    ...
                    <Text w={{ base: "465px", sm: "653.13px", lg: "465px" }} lineHeight={{ base: "21.6px", sm: "30.34px", lg: "21.6px" }} fontSize={{ base: "18px", sm: "25.28px", lg: "18px" }}>Lorem ipsum dolor sit amet, consectetur adipiscing elit. In luctus augue sit amet mollis molestie.</Text>
                ...
                <Box p="0 40px" display={"grid"} gridTemplateColumns={{ base: "repeat(3,1fr)", sm: "repeat(2,1fr)", lg: "repeat(3,1fr)" }} gap={{ base: "25px", sm: "19.22px", lg: "25px" }}>
                    <Box>
                        ...
                        <Text color={"#111822"} mt="1px" fontSize={{ base: "16px", sm: "19.9px", lg: "16px" }}>Category name here</Text>
                    </Box>
                    <Box>
                        <Box w={{ base: "354px", sm: "440.39px", lg: "354px" }} h={{ base: "221px", sm: "274.93px", lg: "221px" }} bg="#077BFF1A" border={"1px solid #077BFF80"} borderRadius="5px">
                        </Box>
