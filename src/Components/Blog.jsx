...
const Blog = () => {
    return (
        <>
            <Box w="80%" h={{ base: "auto", sm: "auto", lg: "859px" }} bg="#F6FAFF" borderRadius={"5px"} border="1px solid #1E1E1E1A" m="auto" mb={{ base: "120px", sm: "320px", lg: "120px" }} mt={{ base: "250px", sm: "234.33px", lg: "250px" }} display="flex" flexDirection={"column"} justifyContent="center" alignItems={"center"}>
                ...
                <Box display={"grid"} gridTemplateColumns={{ base: "repeat(2,1fr)", sm: "repeat(2,1fr)", lg: "repeat(3,1fr)" }} gap={{ base: "19.22px", sm: "19.22px", lg: "25px" }}>
                    <Box>
